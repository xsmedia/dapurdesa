<main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="page-title">Form Tambah Perangkat Desa</h2>
              <p class="text-muted">Lengkapi data aparatur pemerintah desa </p>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                  <input type="text" class="form-control drgpicker" id="date-input1" value="31-01-2021" aria-describedby="button-addon2" name="tgl_lahir">
                                    ...
                                    <select required="" name="pendidikan_id" class="form-control">
                                        <?php
                                            foreach ($list_pendidikan as $data) {
                                                if ($post['pendidikan_id'] == $data['id_pendidikan']) {
                                                    $selected1 = "selected";
                                                } else {
                                                    $selected1 = "";
                                                }
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="radio" name="jenis_kelamin" id="L" class="with-gap" value="1">
                                    <label for="L">Laki Laki</label>
                                </div>                                
                                <div class="radio inlineblock">
                                    <input type="radio" name="jenis_kelamin" id="P" class="with-gap" value="2" checked="">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-3 col-md-6">
                                <div class="form-group">   
                                <label>No. SK</label>                                
                                    <input required="" type="text" name="no_sk" class="form-control" placeholder="Nomor SK" />                                   
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="form-group"> 
                                <label>Tanggal SK</label>                                  
                                   <div class="input-group">
                                  <input type="text" class="form-control drgpicker" id="date-input1" value="31-01-2021" aria-describedby="button-addon2" name="tgl_sk">
                                  <div class="input-group-append">
                                    <div class="input-group-text" id="button-addon-date"><span class="fe fe-calendar fe-16 mx-2"></span></div>
                                  </div>
                                </div>                                  
                                    ...
                                    <select required="" name="jabatan_id" class="form-control">
                                       <?php
                                            foreach ($list_jabatan as $data) {
                                                if ($post['id_jabatan'] == $data['id_jabatan']) {
                                                    $selected1 = "selected";
                                                } else {
                                                    $selected1 = "";
                                                }
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-6">
                                <div class="form-group">      
                                    <label>NIK</label>                             
                                    <input type="text" name="nik" class="form-control" placeholder="No. NIK" />                                    
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group"> 
                        ...
                        <button class="btn btn-raised btn-primary waves-effect" type="submit">Tambahkan</button>
